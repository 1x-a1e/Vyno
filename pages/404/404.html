...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/pages/404/css/404.css" />
    <link rel="icon" type="image/x-icon" href="/pages/404/images/tsParticles-64.png" />
  </head>
  ...
  <body class="permission_denied">
    ...
    <div class="denied__wrapper">
      ...
      <img id="astronaut" src="/pages/404/images/astronaut.svg" />
      <img id="planet" src="/pages/404/images/planet.svg" />
    ...
    ></script>
    <script type="text/javascript" src="/pages/404/js/404.js"></script>
  </body>
</html>
